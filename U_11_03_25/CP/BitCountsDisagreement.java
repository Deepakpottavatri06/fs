...
public class BitCountsDisagreement{
    public static void main(String [] args){
        ...
        System.out.println(totalDisagreements(arr,inp.length));
        cin.close();
    }
    static int totalDisagreements(int arr[], int n){
        int count = 0;
        // for(int i = 0; i < n ; i++){
        //     for(int j = i; j < n ; j++){
        //         count += Integer.bitCount(arr[i]^arr[j]);
        //     }
        // }
        for(int i = 0; i < 31; i++){
            int k = 0;
