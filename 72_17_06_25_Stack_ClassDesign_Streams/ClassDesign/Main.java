...
class CreditReport {
    ...
    CreditReport( Customer c , double score, String riskLevel ){
        this.customer = c;
        this.score = score;
    ...
    public String toString(){
        ...
        String formatted =  String.format("Customer: %s, Score: %.1f, Risk Level: %s",customer.getName(),score,this.riskLevel);
        return formatted;
    }
}
...
class CreditRiskAnalyzerImpl implements RiskAnalyzer {
    ...
    public CreditReport analyzeRisk(Customer customer) {
        ...
        String risk = (finalScore>=80)? "Low" : ((finalScore>=50)? "Medium" : "High");
        return new CreditReport(customer,finalScore,risk);
        // return null;
    }
}
