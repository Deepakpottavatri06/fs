...
select distinct fi.name , fi.category 
from FoodItems fi join Orders o on fi.food_id = o.food_id
join Customers c on c.customer_id = o.customer_id where fi.category = "Main Course" and c.last_name REGEXP "(a|i)$";
